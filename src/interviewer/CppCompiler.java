...
{
    String ans;
    String compileCppFile(String filePath,String fileName)
    {
        ans="";
        String tmp="";
        String compileFileCommand = "g++ " + filePath+"\\"+fileName+" -o a.out";
        System.out.println(compileFileCommand);
        try
        {
            System.out.println("checkpoint2");
            tmp+="Compiling Cpp File\n";
    ...
    String runCppFile(String dirPath) throws Exception
    {
        String smp="";
        if(ans!="")
        {
        ...
        smp+="Running Cpp File\n";
        ans+="Running Cpp File\n";
    ...
    String compile_only()
    {
        ...
        String fileName="q1.cpp";
        s=compileCppFile(path,fileName);
    ...
    String run() throws Exception
    {
        String res="";
        String path = System.getProperty("user.dir");
        String s=compileCppFile(path,"q1.cpp");
        res=runCppFile(path);
        return res;
    }
}
